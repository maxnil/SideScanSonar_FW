...
#define CONF_SCOM_ENABLE_FREERTOS_GPS
#define CONF_SCOM_ENABLE_FREERTOS_RS485
...
#define CONF_SCOM_ENABLE_FREERTOS_TIMER

/* Debug Console UART */
#define CONF_SCOM_CONSOLE_UART_BAUDRATE		115200

/* Sonar GPS UART */
#define CONF_SCOM_GPS_USART_BAUDRATE		4800
