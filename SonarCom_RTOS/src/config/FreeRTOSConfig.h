...
//Max extern uint32_t SystemCoreClock;
#define configENABLE_BACKWARD_COMPATIBILITY		0
#define configUSE_PREEMPTION					1
#define configUSE_PORT_OPTIMISED_TASK_SELECTION	1
#define configUSE_TICKLESS_IDLE					0
//Max#define configUSE_QUEUE_SETS					1
...
//Max #define configTOTAL_HEAP_SIZE					( ( size_t ) ( 16 * 1024 ) )
...
//Max#define INCLUDE_eTaskGetState			1
//Max#define INCLUDE_xTimerPendFunctionCall	1
...
//Max#define configINCLUDE_DEMO_DEBUG_STATS 1
